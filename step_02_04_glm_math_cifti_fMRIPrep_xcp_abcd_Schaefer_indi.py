...
trial_types_full = ['correct_E', 'correct_H', 'wrong_E', 'wrong_H']
        ...
        if not os.path.exists(file_check):
            ...
            for run_ID in run_IDs:
                ...
                if not os.path.exists(file_fmri):
                    ...
                    contrasts = {'Easy': basic_contrasts['correct_E'],
                                 'Hard': basic_contrasts['correct_H'],
                                 'Easy_and_Hard': basic_contrasts['correct_E'] + basic_contrasts['correct_H'],
                                 'Easy_vs_Hard': basic_contrasts['correct_E'] - basic_contrasts['correct_H'],
                                 'Hard_vs_Easy': basic_contrasts['correct_H'] - basic_contrasts['correct_E'],
                                 'Easy_neg': - basic_contrasts['correct_E'],
                                 'Hard_neg': - basic_contrasts['correct_H'],
                                 'Easy_and_Hard_neg': - basic_contrasts['correct_E'] - basic_contrasts['correct_H']
                                 }
